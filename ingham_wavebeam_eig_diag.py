#python ingham_wavebeam_eig_diag.py
import numpy as np
...
axs[2].set_ylim((1.99,2.01))
axs[3].set_ylim((1.99,2.01))
...
data1 = np.loadtxt('to_eig_ell1_pmax10000_T2p1_Nloc50.dat')
data2 = np.loadtxt('to_eig_ell1_pmax10000_T2p1_Nloc100.dat')
data3 = np.loadtxt('to_eig_ell1_pmax10000_T3_Nloc50.dat')
data4 = np.loadtxt('to_eig_ell1_pmax10000_T3_Nloc100.dat')
data5 = np.loadtxt('to_eig_ell10_pmax10000_T2p1_Nloc50.dat')
data6 = np.loadtxt('to_eig_ell10_pmax10000_T2p1_Nloc100.dat')
data7 = np.loadtxt('to_eig_ell10_pmax10000_T10_Nloc50.dat')
data8 = np.loadtxt('to_eig_ell10_pmax10000_T10_Nloc100.dat')
#data9 = np.loadtxt('toto_ell50_pmax10000.dat')


axs[0].plot(phi0(data1),phi1(data1),label='$\ell=1,\ T=2.1,\ N_{loc}=50$')
axs[1].plot(phi0(data2),phi1(data2),label='$\ell=1,\ T=2.1,\ N_{loc}=100$')
axs[2].plot(phi0(data3),phi1(data3),label='$\ell=1,\ T=3,\ N_{loc}=50$')
axs[3].plot(phi0(data4),phi1(data4),label='$\ell=1,\ T=3,\ N_{loc}=100$')
axs[4].plot(phi0(data5),phi1(data5),label='$\ell=10,\ T=2.1,\ N_{loc}=50$')
axs[5].plot(phi0(data6),phi1(data6),label='$\ell=10,\ T=2.1,\ N_{loc}=100$')
axs[6].plot(phi0(data7),phi1(data7),label='$\ell=10,\ T=10,\ N_{loc}=50$')
axs[7].plot(phi0(data8),phi1(data8),label='$\ell=10,\ T=10,\ N_{loc}=100$')
