...
data1 = np.loadtxt('toto_ell0p02_pmax10000_bkl2.dat')
data2 = np.loadtxt('toto_ell0p05_pmax10000_bkl2.dat')
data3 = np.loadtxt('toto_ell0p1_pmax10000_bkl2.dat')
data4 = np.loadtxt('toto_ell0p5_pmax10000_bkl.dat')
data5 = np.loadtxt('toto_ell1_pmax10000_bkl.dat')
data6 = np.loadtxt('toto_ell2_pmax10000_bkl.dat')
data7 = np.loadtxt('toto_ell10_pmax10000_bkl.dat')
data8 = np.loadtxt('toto_ell20_pmax10000_bkl.dat')
data9 = np.loadtxt('toto_ell50_pmax10000_bkl.dat')
